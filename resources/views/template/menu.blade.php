<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">{{ env('APP_NAME') }} <sup>V.01</sup></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Main Parameters:</h6>
                <a class="collapse-item" href="/sbu">SBU Setup</a>
                <a class="collapse-item" href="/uses">Users</a>


                <a class="collapse-item" href="/location">Locations</a>
                <a class="collapse-item" href="/equpmentnames">Equpment Name</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="newequpment">New</a>
